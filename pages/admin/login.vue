  ...
  <v-container fluid fill-height>
        ...
        <v-card color="primary">
          ...
          <v-card-text>
            ...
            >
              ...
              <v-btn block type="submit" color="secondary" class="mt-4" :disabled="!valid">Sign In</v-btn>
              <v-list-item class="mt-2">
                Dont have an account? <span @click="goToSignUp" class="font-weight-bold ml-4" style="cursor: pointer;">Sign Up</span>
              </v-list-item>
            </v-form>
          </v-card-text>
        </v-card>
    ...
    >
      <v-card color="red">
        ...
        <v-card-text>
          <v-list-item>
           <span class="secondary--text text--lighten-4">{{ error }}</span>
          </v-list-item>
        </v-card-text>
      </v-card>
    </v-dialog>
